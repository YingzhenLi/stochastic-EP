...
\caption{(a) A geometric view of AEP/PEP comparison. (b) A cartoon illustration of DEP, SEP and DSEP. For each algorithm we show $q(\bm{\theta})$ on the top and $\tilde{p}_i(\bm{\theta})$ at the bottom. \todo{Needs longer and clearer explanation.}}
